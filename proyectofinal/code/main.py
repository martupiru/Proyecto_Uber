...
printHashTable(load_hash_table_Autos())
print(load_lista_Autos())
load_movil_element(('P6',(('e2',5),('e3',5)),2))  
...
# load_fix_element(('T3',(('e9',20),('e10',5))))
#printHashTable(load_hash_table_Personas())

#PROFES
'''load_fix_element(('H1',(('e8',20),('e10',30))))
load_fix_element(('A1',(('e2',50),('e7',50)))) 
load_fix_element(('T5',(('e2',10),('e6',40)))) 
...
load_movil_element(('P3',(('e7',20),('e9',30)),2500)) 
load_movil_element(('P4',(('e1',15),('e2',85)),500))
load_movil_element(('P5',(('e2',10),('e6',40)))) '''

# uber.load_movil_element(('C1',(('e1',10),('e4',40)),200))
# uber.load_movil_element(('C2',(('e1',60),('e2',40)),50)) 
# uber.load_movil_element(('C3',(('e2',0),('e6',50)),110))
# uber.load_movil_element(('C4',(('e9',35),('e10',15)),20))
# uber.load_movil_element(('C5',(('e5',10),('e7',40)),25)) 
...
# Crear viajes
#printHashTable(load_hash_table_ubicaciones())
#dictionary.printHashTable(loud_elements.load_hash_table_Personas())
#print(load_map())
#create_trip('P5','S10')
#create_trip ('P3', 'T5')
